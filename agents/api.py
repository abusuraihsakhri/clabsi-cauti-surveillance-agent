"""
FastAPI REST API Server for Clabsi Cauti Surveillance Agent.
"""
...
app = FastAPI(
    title="Clabsi Cauti Surveillance Agent API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "clabsi-cauti-surveillance-agent", "domain": "Antimicrobial Stewardship & Microbiology", "standard": "CLSI M100 / EUCAST / CDC NHSN Guidelines", "version": "3.0.0-ENTERPRISE"}
