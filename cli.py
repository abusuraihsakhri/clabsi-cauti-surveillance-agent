"""
Command Line Interface for Clabsi Cauti Surveillance Agent.
"""
import argparse
import csv
import json
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="clabsi-cauti-surveillance-agent", description="Clabsi Cauti Surveillance Agent")
    ...
    if args.command == "audit":
        ...
        print("=" * 80)
        print(f"  CLABSI CAUTI SURVEILLANCE AGENT")
    ...
    if args.command == "chat":
        ...
        print(f"\n[Clabsi Cauti Surveillance Agent Supervisor]:\n{ans}\n")
        return 0
    ...
    if args.command == "serve":
        ...
        print(f"Starting Clabsi Cauti Surveillance Agent API server on http://{args.host}:{args.port}")
