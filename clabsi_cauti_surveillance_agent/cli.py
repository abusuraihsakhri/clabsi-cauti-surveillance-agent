"""
Command-Line Interface for DeviceHAI Sentinel: Autonomous Central Line & Catheter-Associated Infection Arbiter.
"""
import argparse
import csv
import json
...
def main(argv=None):
    ...
    if args.command == "audit":
        ...
        print(f"  Domain: Infection Control | Standard: CDC NHSN Surveillance Guidelines")
