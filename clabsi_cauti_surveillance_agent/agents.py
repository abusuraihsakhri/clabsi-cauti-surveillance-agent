    ...
    def audit(self, case: ClinicalCasePayload) -> List[AgentAlert]:
        ...
        if res:
            alerts.append(AgentAlert(
                ...
                sub_agent="DeviceDwellTimeAgent",
...
class NHSNDefinitionValidatorAgent:
    ...
    def audit(self, case: ClinicalCasePayload) -> List[AgentAlert]:
        ...
        if res:
            alerts.append(AgentAlert(
                alert_id=str(uuid.uuid4())[:8],
                sub_agent="NHSNDefinitionValidatorAgent",
...
class PreventableFractionScorerAgent:
    ...
    def audit(self, case: ClinicalCasePayload) -> List[AgentAlert]:
        ...
        if res:
            alerts.append(AgentAlert(
                alert_id=str(uuid.uuid4())[:8],
                sub_agent="PreventableFractionScorerAgent",
...
class DeviceHAICoordinator:
    ...
    def __init__(self):
        ...
        self.agent_3 = PreventableFractionScorerAgent()
    ...
    def process_case(self, case: ClinicalCasePayload) -> Dict[str, Any]:
        ...
        dossier = {
            ...
            "guideline_standard": "CDC NHSN Surveillance Guidelines",
